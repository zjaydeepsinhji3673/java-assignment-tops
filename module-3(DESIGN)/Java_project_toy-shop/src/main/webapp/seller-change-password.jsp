	...
	<div class="header-outs" id="home">
					...
					<ul class="navbar-nav ">
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="nav-link" href="seller-register.jsp">Upload
									Product</a> <a class="nav-link " href="customer-register.jsp">Manage
									Product</a>
							</div></li>
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="nav-link" href="seller-profile.jsp">Profile</a> <a
									class="nav-link " href="seller-change-password.jsp">Change
									Password</a> <a class="nav-link " href="seller-logout.jsp">Logout</a>
							</div></li>
					</ul>
				</div>
			</nav>
		...
		<section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
			<div class="container py-lg-5 py-md-4 py-sm-4 py-3">
				<h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Seller
					Register</h3>
